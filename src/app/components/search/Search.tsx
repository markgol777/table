    ...
    <div className="w-full max-w-md px-4">
      <div className="relative">
        <Input
          ...
          className="w-[218px] h-[32px] pl-10 pr-3 rounded-lg border border-gray bg-white/5 text-sm text-gray-900 dark:border-white dark:placeholder-white focus:outline-none"
        />
        <MagnifyingGlassIcon
